...
import { BarChart3, Building2, FileCheck, Layers, ShieldCheck, Wallet } from 'lucide-react-native';
...
const styles = StyleSheet.create({
  ...
  card: { flexDirection: 'row', gap: 14, backgroundColor: '#FFFFFF', borderRadius: 12, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#E2E8F0' },
