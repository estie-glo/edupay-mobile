      ...
      <View style={styles.form}>
        ...
        >
          <Text style={styles.inscriptionTxt}>
            ...
            <Text style={styles.inscriptionLnk}>S'inscrire</Text>
          </Text>
        </TouchableOpacity>

        <TouchableOpacity
          style={styles.etablissementBox}
          onPress={() => router.push('/screens/ecole/LoginEcoleScreen')}
        >
          <Text style={styles.etablissementTxt}>
            🏫 Établissement ? Accédez au back-office ici
          </Text>
        </TouchableOpacity>
